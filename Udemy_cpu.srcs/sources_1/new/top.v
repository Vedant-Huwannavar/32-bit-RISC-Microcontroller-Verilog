...
reg [15:0] GPR [31:0]; // 16 General Purpose Registers each of 32 bit


reg [15:0] SGPR;  // 16 bit Special General Puropse Register for Multiplication

reg [31:0] mul_res; // storing the multiplication result first in this temperory register
...
//////////////////reading program
/*initial begin
$readmemb("C:/Users/vedan/OneDrive/Desktop/inst_data.mem",inst_mem);
end*/

integer i;  // <-- Declare outside the initial block

initial begin
  $readmemb("multiply_six_five_by_adding.mem", inst_mem);
  /*$display("Instruction Memory Loaded:");
  for (i = 0; i < 18; i = i + 1) begin
    $display("inst_mem[%0d] = %b", i, inst_mem[i]);
  end*/
end
